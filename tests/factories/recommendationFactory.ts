...
export function getObject(name: string = faker.name.findName(), genresIds: number[] = [], youtubeLink: string = "https://www.youtube.com/watch?v=ePjtnSPFWK8&ab_channel=CHXVEVO") {
    return {
        name,
        youtubeLink,
        genresIds
